defmodule EyepatchTest do
  ...
  test "test1" do
    ...
    :timer.tc(Eyepatch, :resolve, [url, request_hackney(), &is_ok_hackney/1])
  end
  ...
  def request_hackney() do
    connect_ = fn uri, ip_address, _protocol, connect_timeout ->
